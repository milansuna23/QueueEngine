...
function start(id) {
  console.log({ type: 'info', message: `starting Customer service id: ${id}` });
  ...
  function onError(err) {
    console.log({ type: 'error', service: 'Customer', error: err, stack: err.stack || 'No stacktrace' }, process.stderr);
    console.log({ type: 'info', message: 'killing Customer' });
    process.exit();
  }
}