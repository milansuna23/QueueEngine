...
function start(id) {
  console.log({ type: 'info', message: `starting Auth service id: ${id}` });
  ...
  function onError(err) {
    console.log({ type: 'error', service: 'Auth', error: err, stack: err.stack || 'No stacktrace' }, process.stderr);
    console.log({ type: 'info', message: 'killing Auth' });
    process.exit();
  }
}